...
namespace Templater::dynamic {
    ...
    class NodeHandle {
        private:
            ...
            /**
             * @brief If this is owning, deletes the pointer. Otherwise, the pointer is set to nullptr 
             * 
             */
            void reset();
        public:
            /**
             * @brief Construct a new Node Handle object using a unique_ptr. The constructed NodeHandle is owning.
             * 
            ...
            /**
             * @brief Construct a new Node Handle object using a raw pointer. The constructed NodeHandle is non-owning by default.
             * This behaviour can be changed via the owns property.
             * 
             * @param raw 
             * @param owns 
             */
            ...
            /**
             * @brief Constructs a unique_ptr from this and sets owning to false if and only if this is owning. Otherwise throws an std::logic_error.
             * 
            ...
            /**
             * @brief Releases the underlying pointer no matter if owning or not. Sets the underlying pointer to nullptr and ownership to non-owning.
             * 
             * @return Node* 
             */
            Node* release();

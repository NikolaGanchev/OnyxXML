...
NodeHandle::NodeHandle(Node* raw, bool owns) : pointer(raw), isOwning(owns) {}
...
Node* NodeHandle::get() { return this->pointer; }

const Node* NodeHandle::get() const { return this->pointer; }

Node& NodeHandle::operator*() { return *this->pointer; }

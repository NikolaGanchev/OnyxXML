...
namespace Templater::compile { 
    ...
    /**
     * @brief Document struct adapted for dealing with template XML with Placeholders.
     * Document::serialize() and Document::dynamicTree() are replaced with appropriate 
     * PlaceholderDocument::serializeWithPlaceholders() and PlaceholderDocument::dynamicTreeWithPlaceholders().
     * 
     * Example usage:
     * @code{.cpp}
    ...
    struct PlaceholderDocument {
        ...
        public:
            ...
            /**
             * @brief Evaluate at runtime the output from the compile time Document::serialize().
             * Searches for and replaces the Placeholder with a given name with the serialization of the given Node.
             * 
             * @tparam Rest 
            ...
            /**
             * @brief Evaluate at runtime the dynamic tree with placeholders from Document::dynamicTree().
             * Searches for and replaces the Placeholder Nodes with a given name with the given node. 
             * Ownership of given nodes is taken over.
             * 
             * @tparam T 
             * @tparam Rest 
             * @param name Placeholder name
        ...
        private:
            ...
            /**
             * @brief Replace a single Placeholder of the serialization with the serialization of the given Node.
             * 
             * @param result 
             * @param name 
             * @param node 

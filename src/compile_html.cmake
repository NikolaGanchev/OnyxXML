set(FOUND_DOCUMENTS_FILE "${CMAKE_BINARY_DIR}/found_documents.txt")
...
function(register_compile_html_executable EXECUTABLE_TARGET)
    ...
    file(WRITE ${FOUND_DOCUMENTS_FILE} "")
    foreach(FILE ${USER_FILES})
        file(READ ${FILE} CONTENTS)
        string(REGEX MATCHALL ${COMPILE_DOCUMENT_REGEX} MATCHES ${CONTENTS})
        foreach(MATCH ${MATCHES})
            file(APPEND ${FOUND_DOCUMENTS_FILE} "${MATCH}\n")
        endforeach()
    endforeach()

    # Set environment variable
    set(ENV{COMPILE_TIME_HTML} "true")

...
namespace Templater::dynamic::tags {
    ...
    /**
     * @brief A XmlDeclaration Node. Contains data about the XML version of the file, the encoding and whether the file contains external markup declarations.
     * Version info is always available; encoding and standalone can be skipped and have default values of "UTF-8" and false, respectively.
     * 
     */
    class XmlDeclaration: public ProcessingInstruction {
        ...
        public:
             ...
             */
            explicit XmlDeclaration(std::string versionInfo, std::string encoding, bool standalone, bool escapeMultiByte = false);
             ...
             * @param escapeMultiByte 
             */
            explicit XmlDeclaration(std::string versionInfo, std::string encoding, bool hasEncoding, bool standalone, bool hasStandalone, bool escapeMultiByte = false);
             ...
             * @param escapeMultiByte 
             */
            explicit XmlDeclaration(std::string versionInfo, bool escapeMultiByte = false); 
             ...
             * @param escapeMultiByte 
             */
            explicit XmlDeclaration(NonOwningNodeTag, std::string versionInfo, std::string encoding, bool standalone, bool escapeMultiByte = false);
             ...
             * @param escapeMultiByte 
             */
            explicit XmlDeclaration(NonOwningNodeTag, std::string versionInfo, bool escapeMultiByte = false); 
             ...
             * @param escapeMultiByte 
             */
            explicit XmlDeclaration(NonOwningNodeTag, std::string versionInfo, std::string encoding, bool hasEncoding, bool standalone, bool hasStandalone, bool escapeMultiByte = false);
            ...
            /**
             * @brief The tag name of a processing instruction node is the invalid xml tag name ".xml". 

...
namespace Templater::dynamic::tags {
     ...
     * Does no escaping except multibyte if shouldEscapeMultiByte is true - although that is probably not desired behavior.
     * 
     */
    class Doctype: public Text {
        ...
        public:
            /**
             * @brief The tag name of a comment node is the invalid xml tag name ".doctype". 

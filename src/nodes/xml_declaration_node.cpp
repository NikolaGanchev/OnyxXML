...
namespace Templater::dynamic::tags {
    ...
    XmlDeclaration::XmlDeclaration(std::string versionInfo, std::string encoding, bool standalone, bool escapeMultiByte)
    ...
    XmlDeclaration::XmlDeclaration(std::string versionInfo, std::string encoding, bool hasEncoding, bool standalone, bool hasStandalone, bool escapeMultiByte)
        : versionInfo(versionInfo), 
        encoding(encoding), 
    ...
    XmlDeclaration::XmlDeclaration(NonOwningNodeTag, std::string versionInfo, std::string encoding, bool hasEncoding, bool standalone, bool hasStandalone, bool escapeMultiByte)
        : versionInfo(versionInfo), 
        encoding(encoding), 
        hadEncoding(hasEncoding),
        standalone(standalone),
    ...
    XmlDeclaration::XmlDeclaration(NonOwningNodeTag, std::string versionInfo, std::string encoding, bool standalone, bool escapeMultiByte)
        : versionInfo(versionInfo), 
        encoding(encoding), 
        hadEncoding(true),
        standalone(standalone), 
    ...
    XmlDeclaration::XmlDeclaration(NonOwningNodeTag, std::string versionInfo, bool escapeMultiByte)
        : versionInfo(versionInfo), 
        hadEncoding(false),
        encoding("UTF-8"), 
        standalone(false), 
    ...
    bool XmlDeclaration::getStandalone() const {
    ...
    bool XmlDeclaration::hasSpecialSerialization() const {
        return true;
    }
    
    std::unique_ptr<Node> XmlDeclaration::shallowCopy() const {
        return std::make_unique<XmlDeclaration>(this->versionInfo, this->encoding, this->standalone, this->shouldEscapeMultiByte());
    }

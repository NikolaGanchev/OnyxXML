...
std::string_view Instruction::functionCodeToString(FUNCTION_CODE fc) {
    switch (fc) {
        case FUNCTION_CODE::LAST_0:
            return "last";
        case FUNCTION_CODE::POSITION_0:
            return "position";
        case FUNCTION_CODE::COUNT_1:
            return "count";
        case FUNCTION_CODE::ID_1:
            return "id";
        case FUNCTION_CODE::LOCAL_NAME_1:
            return "local-name";
        case FUNCTION_CODE::NAMESPACE_URI_1:
            return "namespace-uri";
        case FUNCTION_CODE::NAME_1:
            return "name";
        case FUNCTION_CODE::STRING_1:
            return "string";
        case FUNCTION_CODE::CONCAT_2:
            return "concat";
        case FUNCTION_CODE::STARTS_WITH_2:
            return "starts-with";
        case FUNCTION_CODE::CONTAINS_2:
            return "contains";
        case FUNCTION_CODE::SUBSTRING_BEFORE_2:
            return "substring-before";
        case FUNCTION_CODE::SUBSTRING_AFTER_2:
            return "substring-after";
        case FUNCTION_CODE::SUBSTRING_2:
            return "substring2";
        case FUNCTION_CODE::SUBSTRING_3:
            return "substring3";
        case FUNCTION_CODE::STRING_LENGTH_1:
            return "string-length";
        case FUNCTION_CODE::NORMALIZE_SPACE_1:
            return "normalize-space";
        case FUNCTION_CODE::TRANSLATE_3:
            return "translate";
        case FUNCTION_CODE::BOOLEAN_1:
            return "boolean";
        case FUNCTION_CODE::NOT_1:
            return "not";
        case FUNCTION_CODE::TRUE_0:
            return "true";
        case FUNCTION_CODE::FALSE_0:
            return "false";
        case FUNCTION_CODE::LANG_1:
            return "lang";
        case FUNCTION_CODE::NUMBER_1:
            return "number";
        case FUNCTION_CODE::SUM_1:
            return "sum";
        case FUNCTION_CODE::FLOOR_1:
            return "floor";
        case FUNCTION_CODE::CEILING_1:
            return "ceiling";
        case FUNCTION_CODE::ROUND_1:
            return "round";
    }

...
class Compiler {
   private:
    ...
    /**
     * @brief Mapping between function names and their FUNCTION_CODE and number
     * of arguments. For functions with optional arguments, returns the greatest
     * possible amount of arguments. For 'concat', which has a variadic number

...
class __DangerousRawText : public Node, public Node::SpecialSerializable {
   ...
   public:
    /**
     * @brief Construct a new owning __DangerousRawText object by given text.
     * Escaping is not done.
     *
     * @param text
     */
    ...
    /**
     * @brief Construct a new non-owning __DangerousRawText object by given
     * text. Escaping is not done.
     *
     * @param text
     */
     ...
     * ".rawText". This signals it shouldn't be used as a tag and is a marker of
     * the class.
     *
    ...
    /**
     * @brief Get a dangerous text string. The text string is NOT escaped. It

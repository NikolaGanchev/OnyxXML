...
class ProcessingInstruction : public Text {
   ...
   public:
    /**
     * @brief Construct a new owning ProcessingInstruction by given target and
     * text
     *
     * @param text
     * @param target
     ...
     */
    explicit ProcessingInstruction(std::string target, std::string text,
     ...
     * @param escapeMultiByte
     */
    explicit ProcessingInstruction(NonOwningNodeTag, std::string target,
                                   std::string text,
                                   bool escapeMultiByte = false);
    ...
    /**
     * @brief Get the target string. The target of a processing instruction is
     * the tag name part of the instruction. For example:
     * @code{.xml}
     ...
     * tag name ".pi". This signals it shouldn't be used as a tag and is a
     * marker of the class.
     *
     * @return const std::string&
     */

 ...
 * accept children. All void nodes should derive from the VoidNode base instead
 * of Node. Although VoidNode cannot have children, it can still be non-owning
 * to upkeep tree integrity.
 *
 */
class VoidNode : public Node {
   public:
     ...
     */
    template <typename... Args>
    explicit VoidNode(NonOwningNodeTag, Args&&... args)
        requires(isAttribute<Args> && ...);
